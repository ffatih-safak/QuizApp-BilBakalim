...
import 'package:login_page_day_23/sorular/kelimeSorulari.dart';
import 'package:login_page_day_23/sorular/Genelsorular.dart';

class KelimeSplashScreen extends StatefulWidget {
  @override
  _MyAppState createState() => _MyAppState();
}

class _MyAppState extends State<KelimeSplashScreen> {
  @override
  void initState() {
    super.initState();
    Future.delayed(Duration(seconds: 5), () {
      Navigator.push(
          context, MaterialPageRoute(builder: (context) => KelimeSorulari()));
    });
  }
