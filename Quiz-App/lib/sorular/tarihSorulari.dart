...
class TarihSorulari extends StatelessWidget {
...
class _SoruSayfasiState extends State<SoruSayfasi> {
  ...
  bool soruBittiMi() {
    if (soruIndex + 1 >= genelSorular.soruBankasi.length) {
     ...
     ClassTarihSorular genelSorular = new ClassTarihSorular();
     ClassTarihSorularCevap genelSorularCevap = new ClassTarihSorularCevap();
