...
class BilimSorulari extends StatelessWidget {
...
class _SoruSayfasiState extends State<SoruSayfasi> {
  ...
  bool soruBittiMi() {
    if (soruIndex + 1 >= genelSorular.soruBankasi.length) {
     ...
     ClassBilimSorular genelSorular = new ClassBilimSorular();
     ClassBilimSorularCvp genelSorularCevap = new ClassBilimSorularCvp();
