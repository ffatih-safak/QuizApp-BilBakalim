...
class MuzikSorulari extends StatelessWidget {
...
class _SoruSayfasiState extends State<SoruSayfasi> {
  ...
  bool soruBittiMi() {
    if (soruIndex + 1 >= genelSorular.soruBankasi.length) {
     ...
     ClassMuzikSorular genelSorular = new ClassMuzikSorular();
     ClassMuzikSorularCevap genelSorularCevap = new ClassMuzikSorularCevap();
