...
class KelimeSorulari extends StatelessWidget {
...
class _SoruSayfasiState extends State<SoruSayfasi> {
  ...
  bool soruBittiMi() {
    if (soruIndex + 1 >= genelSorular.soruBankasi.length) {
     ...
     ClassKelimeSorular genelSorular = new ClassKelimeSorular();
     ClassKelimeSorularCevap genelSorularCevap = new ClassKelimeSorularCevap();
