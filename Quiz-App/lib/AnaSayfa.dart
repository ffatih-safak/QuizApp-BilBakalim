...
import 'package:login_page_day_23/RasgeleBilgi.dart';
import 'package:login_page_day_23/UygulamaHakk%C4%B1nda.dart';
...
import 'package:login_page_day_23/ileti%C5%9Fim.dart';
import 'package:login_page_day_23/splashScreen/BilimSplash.dart';
import 'package:login_page_day_23/splashScreen/GenelsplashScreen.dart';
import 'package:login_page_day_23/sorular/muzik.dart';
import 'package:login_page_day_23/splashScreen/TarihsplashScreen.dart';
import 'package:login_page_day_23/splashScreen/kelimeSplash.dart';
import 'package:login_page_day_23/splashScreen/sporSplash.dart';

import 'bilgiler/kelimeBilgi.dart';
        ...
        children: <Widget>[
          new GestureDetector(
            onTap: () {
              Navigator.push(
                context,
                MaterialPageRoute(builder: (context) => GenelSplashScreen()),
              );
            },
            child: Container(
              decoration: BoxDecoration(
          ...
          new GestureDetector(
            onTap: () {
              Navigator.push(
                context,
                MaterialPageRoute(builder: (context) => TarihSplashScreen()),
              );
            },
            child: Container(
              decoration: BoxDecoration(
          ...
          new GestureDetector(
            onTap: () {
              Navigator.push(
                context,
                MaterialPageRoute(builder: (context) => SporSplashScreen()),
              );
            },
            child: Container(
              decoration: BoxDecoration(
          ...
          new GestureDetector(
            onTap: () {
              Navigator.push(
                context,
                MaterialPageRoute(builder: (context) => BilimSplashScreen()),
              );
            },
            child: Container(
              decoration: BoxDecoration(
          ...
          new GestureDetector(
            onTap: () {
              Navigator.push(
                context,
                MaterialPageRoute(builder: (context) => KelimeSplashScreen()),
              );
            },
            child: Container(
              decoration: BoxDecoration(
          ...
          new GestureDetector(
            onTap: () {
              Navigator.push(
                context,
                MaterialPageRoute(builder: (context) =>   MuzikSorulari()),
              );
            },
            child: Container(
              decoration: BoxDecoration(
